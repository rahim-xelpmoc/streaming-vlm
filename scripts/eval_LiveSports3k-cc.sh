...
# predict
python streaming_vlm/eval/livesports3kcc/distributed_generate_streaming.py  --model_name_or_path xrorrim/StreamingVLM --output_dir results/livesports3k/streamingvlm --num_workers 8 --temperature 0.9 --repetition_penalty 1.05
# judge
