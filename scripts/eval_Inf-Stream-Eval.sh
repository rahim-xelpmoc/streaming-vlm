# Generate
    # StreamingVLM
./streaming_vlm/eval/model_compete/generate.sh -m xrorrim/StreamingVLM -b Qwen # infinite stream
    # LiveCC
...
# Merge
./streaming_vlm/eval/model_compete/merge.sh xrorrim/StreamingVLM
...
# Score
./streaming_vlm/eval/model_compete/score.sh --model1 "xrorrim/StreamingVLM" --model2 "gpt-4o-mini" 
