...
def lce_forward(
    ...
    **loss_kwargs,
    ...
    #             input_ids, image_grid_thw, video_grid_thw, second_per_grid_ts, attention_mask # second_per_grid_ts is added
    #         )
    ...
    if position_ids is None and (attention_mask is None or attention_mask.ndim == 2):
        ...
        #         print(f"past_key_values.get_seq_length(): {past_key_values.get_seq_length()}")
