...
def prepare_multiturn_multimodal_inputs_for_generation(
    ...
    **kwargs,
    ...
    """
    Prepare model inputs for the generation phase. Typical steps include computing a 4D attention mask
    and slicing inputs when a cache is present.

    See the model's `forward` documentation for expected arguments (requirements for items like
    `past_key_values` can differ across models). This function is suitable for most LLMs.
    """
